...
% ================================== LUKA ======================================
\subsection{Onlajn testiranje korišćenjem učenja uslovljavanjem } % ONLINE REINFORCEMENT LEARNING
%\label{subsec:pregled}
% ==============================================================================
...
Za ovaj problem koristićemo algoritam mašinskog učenja koji spada u učenje uslovljavanjem, o kome su osnove date ranije u radu. % OSNOVE RL
...
Najmanje frekfentna: 
Klasičnu implementaciju familije algoritama učenja uslovljavanjem modifikujemo idejom anti-ant algoritma [?] kako bi se izbeglo generisanje generacija redudantnih testova. %RL
